...
![](/img/尚硅谷-JavaSE课堂笔记.assets/进程概念.png)

2、一个应用程序的多次运行，就是多个进程

![1563267431480](/img/尚硅谷-JavaSE课堂笔记.assets/1563267431480.png)
...
- 抢占式调度
  ...
  - 抢占式调度详解
    ...
    ![抢占式调度](/img/尚硅谷-JavaSE课堂笔记.assets/抢占式调度.bmp)
